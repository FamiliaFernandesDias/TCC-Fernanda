\input{Capitulos/0.01!-preambulo}
\input{Capitulos/1.01-1.02!-capa-folha_de_rosto}
...
% \include{Capitulos/1.05!-aprovacao}
% \include{Capitulos/1.06#-dedicatoria}
% \include{Capitulos/1.07#-agradecimentos}
% \include{Capitulos/1.08#-epigrafe}
% \include{Capitulos/1.09!-resumo}
% \include{Capitulos/1.10!-abstract}
...
A metodologia ativa é um termo amplo que se refere a abordagens de ensino e aprendizagem que colocam o aluno no centro do processo educacional, em vez de apenas receber informações passivamente, os alunos são encorajados a participar ativamente de sua própria aprendizagem por meio de atividades práticas, colaborativas e reflexivas.

A metodologia ativa de resolução de problemas é uma abordagem educacional que coloca os alunos no centro do processo de aprendizagem, incentivando-os a resolver problemas do mundo real por meio da aplicação de conhecimentos e habilidades. Ao contrário dos métodos tradicionais de ensino, nos quais os alunos são frequentemente receptores passivos de informações, as metodologias ativas de resolução de problemas promovem a participação ativa dos alunos, estimulando o pensamento crítico, a criatividade e a colaboração.

A avaliação através da resolução de problemas é uma metodologia de ensino-aprendizagem muito eficaz para a disciplina de matemática. Ela não apenas avalia o conhecimento dos alunos sobre os conceitos matemáticos, mas também sua capacidade de aplicar esses conceitos na resolução de situações do mundo real.

\section{Problemática}

Como tornar o aprendizado da geometria espacial mais significativo e relevante, de modo a promover uma compreensão mais profunda e duradoura dos conceitos geométricos, considerando que a geometria espacial está presente em nosso cotidiano, mas os alunos frequentemente não conseguem fazer essa conexão e aplicá-la de maneira prática?

\section{Objetivos}

Objetivo Geral:

Tornar o aprendizado mais significativo e relevante, promovendo uma compreensão mais profunda e duradoura dos conceitos geométricos, visto que, a geometria espacial está ao nosso redor. 

Abaixo estão alguns objetivos específicos que podem ser alcançados com esta metodologia aplicada na geometria espacial:

\begin{enumerate}
    \item Desenvolver Habilidades de Resolução de Problemas
    \begin{itemize}
        \item \textbf{Raciocínio Lógico}: Estimular o pensamento crítico e a capacidade de formular e testar hipóteses.
        \item \textbf{Criatividade}: Incentivar a busca por múltiplas soluções para um mesmo problema.
        \item \textbf{Perseverança}: Ensinar a importância da persistência diante de desafios complexos.
    \end{itemize}
    \item Compreender Conceitos Geométricos em Profundidade
    \begin{itemize}
        \item \textbf{Visualização Espacial}: Ajudar os alunos a desenvolver uma compreensão intuitiva e visual de formas tridimensionais.
        \item \textbf{Relações Geométricas}: Explorar as relações entre diferentes figuras geométricas.
        \item \textbf{Relações e Propriedades}: Aplicar relações e propriedades geométricas em contextos práticos e problemas do mundo real.
    \end{itemize}
    \item Aplicação Prática da Geometria
    \begin{itemize}
        \item \textbf{Contextualização}: Relacionar os conceitos geométricos com situações cotidianas e profissionais, como arquitetura, engenharia e design.
        \item \textbf{Modelagem Matemática}: Utilizar a geometria para modelar e resolver problemas reais, incentivando uma visão prática da matemática.
    \end{itemize}
    \item Desenvolvimento de Competências Transversais
    \begin{itemize}
        \item \textbf{Trabalho em Equipe}: Promover a colaboração e o trabalho em equipe para resolver problemas complexos.
        \item \textbf{Comunicação}: Melhorar as habilidades de comunicação ao apresentar soluções e raciocínios.
        \item \textbf{Autonomia}: Incentivar a autonomia e a capacidade de autogestão na aprendizagem.
    \end{itemize}
    \item Engajamento e Motivação
    \begin{itemize}
        \item \textbf{Interesse}: Aumentar o interesse dos alunos pela matemática, tornando as aulas mais dinâmicas e envolventes.
        \item \textbf{Satisfação}: Proporcionar uma sensação de conquista e satisfação ao resolver problemas desafiadores.
    \end{itemize}
\end{enumerate}

\section{Justificativa}

Nesse contexto, os professores desempenham o papel de facilitadores, guiando os alunos através do processo de resolução de problemas e fornecendo suporte conforme necessário. As atividades podem incluir estudos de caso, simulações, projetos de grupo, debates e experiências práticas, todas projetadas para envolver os alunos de forma significativa e promover uma compreensão mais profunda dos conceitos.

Algumas etapas que geralmente fazem parte dessa metodologia:

\begin{itemize}
    \item \textbf{Identificação do problema}: inicia-se definindo claramente o problema ou desafio a ser resolvido. Podendo ser feito por meio de perguntas abertas que estimulam a reflexão e a investigação.
    \item \textbf{Contextualização}: conectar o problema ao contexto da vida real ou ao conteúdo que está sendo estudado. Ajudando os alunos a perceberem a relevância do problema e a se engajarem mais na resolução.
    \item \textbf{Exploração e pesquisa}: incentivar os alunos a explorarem diferentes perspectivas e a realizarem pesquisas para coletar informações relevantes para a resolução do problema. Isso pode envolver experimentação, análise de dados, leitura de textos, entre outras atividades.
    \item \textbf{Colaboração}: promover a colaboração entre os alunos, permitindo que trabalhem em equipe para discutir ideias, compartilhar descobertas e propor soluções. Isso ajuda a desenvolver habilidades sociais e a capacidade de trabalhar em grupo.
    \item \textbf{Experimentação e prototipagem}: encorajar os alunos a testarem suas ideias por meio de experimentação e prototipagem. Isso pode envolver a criação de modelos, simulações ou outras representações tangíveis das soluções propostas.
    \item \textbf{Reflexão e avaliação}: após a experimentação, reservar um tempo para os alunos refletirem sobre o processo e avaliarem suas soluções. Isso pode incluir a identificação de pontos fortes, áreas de melhoria e aprendizados adquiridos durante o processo.
    \item \textbf{Apresentação e compartilhamento}: finalmente, dar oportunidades para os alunos apresentarem suas soluções, compartilharem aprendizados com os colegas e receberem \textit{feedback} construtivo. Isso completa o ciclo de aprendizagem e incentiva a comunicação eficaz.
\end{itemize}

Os problemas devem ser contextualizados para torná-los relevantes para os alunos. Isso pode envolver situações cotidianas, problemas relacionados a outras disciplinas ou até mesmo desafios do mundo profissional. A avaliação deve incluir uma variedade de problemas, desde os mais simples até os mais complexos. Isso permite avaliar diferentes habilidades matemáticas dos alunos, como cálculos básicos, interpretação de gráficos, resolução de equações, entre outros. Podem ser elaborados para avaliar diferentes habilidades cognitivas, como compreensão, análise, síntese e avaliação. Isso ajuda a avaliar não apenas o conhecimento factual, mas também a capacidade dos alunos de pensar criticamente e resolver problemas de forma independente.

A resolução de problemas também pode ser utilizada como uma ferramenta de avaliação formativa, ou seja, durante o processo de aprendizagem para identificar lacunas no conhecimento e ajustar a instrução de acordo com as necessidades dos alunos.

Ao utilizar a resolução de problemas como método de avaliação em matemática, os professores podem não apenas avaliar o desempenho dos alunos de forma mais abrangente, mas também promover um ambiente de aprendizagem mais engajador e significativo.

\section{Metodologia da Pesquisa}

Este trabalho se constitui enquanto uma pesquisa de abordagem qualitativa. Quanto aos objetivos é uma pesquisa exploratória que, segundo Gil (1999, p. 43), tem como objetivo ``proporcionar uma visão geral, de tipo aproximativo, acerca de determinado fato''.  Assim, pretende-se explorar as possibilidades de utilização de uma sequência didática no ensino de um conteúdo de Matemática e os resultados de sua utilização.
...
% Parte principal do texto, que contém a exposição ordenada e pormenorizada do assunto. Divide-se capitulos, seções e subseções, que variam em função da abordagem do tema e do método. Pode ter: Revisão Bibliográfica, Material e Métodos, Resultados, Discussão

\chapter{Referencial Teórico} \label{cap:2_referencial}

Inicialmente resolveu-se fazer uma pesquisa bibliográfica acerca do tema, a fim de revisar a literatura e desenvolver a investigação com base em estudos já realizados.
...
Surgem assim as metodologias ativas como proposta para ``focar o processo de ensinar e aprender na busca da participação ativa de todos os envolvidos, centros na realidade em que estão inseridos'' \cite{FIALHO2017} (p.66).

O pensamento pedagógico de \cite{DEWEY1979} (apud \cite{LOVATO2018} p. 156-157) defende a liberdade por parte do aluno em buscar seu próprio conhecimento.
...
Para \cite{SOUSA2022} (p.29) ``as Metodologias Ativas de Aprendizagem são ferramentas de ensino colaborativo centradas no aluno, em que os alunos são incentivados a participar de discussões e atividades práticas'', as metodologias ativas são compreendidas ``[...] como práticas pedagógicas alternativas ao ensino tradicional''. 

\cite{MORAN2018} apresenta as Metodologias Ativas como estratégias de aprendizagem aplicadas nos processos de ensino, onde o estudante é o centro deste processo, e os autores \cite{Santos2022} afirmam que as Metodologias Ativas têm como princípio a autonomia, a problematização da realidade e sua reflexão, a valorização do trabalho em equipe e a inovação
...
\begin{table}[htbp]
	\centering
		...
		\hline
				\hline\\
		Aluno & O estudante é agente construtor de seu próprio conhecimento, tem controle do processo de aprendizagem, sendo guiado por atividades que permitam ser mais ativo e participativo. \\
		\hline
		Autonomia & Um aluno com controle de seu processo de aprendizagem, desenvolve sua autonomia, devido a postura crítica e coparticipativa durante o processo de ensino e da liberdade durante as aulas. \\
		\hline
		...
		\hline
  Trabalho em equipe & As estratégias didáticas adotadas estão repletas de momentos de discussão e de interação social, refletindo na atitude do aluno e do professor, criando um ambiente em que há possibilidade de opinar e argumentar, no qual as trocas com o outro são vistas positivamente. \\
		\hline
  Inovação & Inovar é buscar maneiras alternativas de interação entre o professor e o aluno, que fujam da aula pautada na transmissão pelo professor e a absorção de conteúdos e o papel de ouvinte passivo do aluno. \\
  \hline
  Professor & Possui um papel de mediador, de facilitador, de orientador e não mais de fonte de informações e de transmissor delas. \\
  \hline
		  	\end{tabularx}
        \caption{Princípios das Metodologias Ativas propostas por Santos e Castaman (2022)}
        \label{tab:Princípios das Metodologias Ativas propostas por Santos e Castaman}
\end{table}
\end{comment}
...
\cite{SOUSA2022} (p.33) indica que ``é importante destacar que as Aprendizagens Ativas possuem princípios articulados com correntes teóricas consagradas, dos quais o mais importante é o Ensino centrado no aluno, que deve ser estimulado a ter uma postura ativa, exercitando assim sua autonomia''.
...
A escolha da metodologia pode depender do contexto, dos objetivos de aprendizagem e das preferências dos educadores e dos alunos, pois conforme indica \citeonline{MASETTO2012}, ``[...] toda aprendizagem, para que realmente aconteça, precisa ser significativa para o aprendiz, isto é, precisa envolvê-lo como pessoa, como um todo: ideias, inteligência, sentimento, cultura, profissão e sociedade'' \cite{MASETTO2012} (p.04). 
...
Assim, segundo \cite{NOGUEIRA2020} os choques entre as deficiências no ensino atual, tem sido relatada como falta de protagonismo dos estudantes emanadas pelos modelos de educação tradicional.
...
Segundo os autores, o ensino por meio de jogos possibilita a criação de um ambiente motivador que é necessário para a maximização de potenciais, o que facilita a dinâmica do processamento cognitivo de informações  \cite{CARVALHO2021}, ``ampliação progressiva da capacidade de abstração e da autonomia de ação e de pensamento, possibilitando ao aluno explorar aspectos mais complexos das relações consigo mesmo, com os outros, com os outros e com o ambiente'' \cite{Educacao.SecretariadeEducacaoFundamental2017}  (p.295).

Sendo assim, o estudo em questão traz autores que enfatizam e complementam sobre a temática abordada dando suporte e evidenciando que os novos métodos de ensino são um desafio no ensino de Ciências Biológicas, pois exigem do professor um planejamento ainda mais completo com seleção criteriosa de estratégias capazes de promover a participação ativa do aluno na aprendizagem, ou seja, tornando o professor também mais ativo no processo de ensino. 

\subsection{Os Tipos de Metodologias Ativas na literatura}

As metodologias ativas não se restringem a um único método de aplicação, mas a variadas práticas que tem como objetivo tornar a aula mais proveitosa e dinâmica, e \cite{Santos2022} propõem diversos exemplos de metodologias ativas
% (QUADRO \ref{tab:Tipos de Metodologias Ativas})
.
...
\begin{table}[htbp]
	\centering
        ...
        \caption{Tipos de Metodologias Ativas propostas por \citeonline{Santos2022}}
        \label{tab:Tipos de Metodologias Ativas}
		\begin{tabularx}{\textwidth}{|X|X|X|X|X|}
		\hline
				\hline\\
		Aprendizagem baseada em problemas (PBL) & Nessa abordagem, os alunos são apresentados a problemas complexos e tarefas que precisam ser resolvidas, eles trabalham em grupos para investigar, pesquisar e encontrar soluções para esses problemas. \\
		\hline
		Aprendizagem baseada em projetos (PBP) & Os alunos trabalham em projetos significativos e de longo prazo que desativam pesquisa, planejamento e execução, podem abranger diversas disciplinas e promover a colaboração, a criatividade e a resolução de problemas. \\
		\hline
		Sala de aula invertida & Nessa abordagem, os alunos estudam o material antes da aula, muitas vezes por meio de vídeos ou leituras, e a sala de aula é usada para discussão, atividades práticas e esclarecimento de dúvidas.  \\
		\hline
  Aprendizagem colaborativa & A aprendizagem colaborativa envolve os alunos trabalhando em grupos para alcançar objetivos de aprendizagem. Eles compartilham conhecimentos, resolvem problemas juntos e aprendem uns com os outros, promovendo habilidades de trabalho em equipe e comunicação. \\
		\hline
  Gamificação & A gamificação incorpora elementos de jogos na aprendizagem para torna-la mais envolvente e motivadora. \\
  \hline
  Ensino por descoberta & Nessa metodologia, os alunos são incentivados a descobrir conceitos e princípios por meio da exploração ativa, experimentação e resolução de problemas, em vez de receber informações passivamente. \\
  \hline
  Aprendizagem baseada em equipe & Os alunos trabalham em equipes para tarefas ou projetos, promovendo a realização, a comunicação e o desenvolvimento de habilidades interpessoais. \\
  \hline
  Ensino híbrido & Combina elementos do ensino presencial e online para oferecer flexibilidade e personalização na aprendizagem. \\
  \hline
  Aprendizagem auto-organizada & Os alunos têm a responsabilidade de definir seus próprios objetivos de aprendizagem, selecionar recursos e avaliar seu próprio progresso. \\
  \hline
		  	\end{tabularx}
\end{table}
\end{comment}
...
\begin{itemize}
    \item \textbf{Aprendizagem baseada em problemas (PBL)}: nessa abordagem, os alunos são apresentados a problemas complexos e tarefas que precisam ser resolvidas, eles trabalham em grupos para investigar, pesquisar e encontrar soluções para esses problemas.
    \item \textbf{Aprendizagem baseada em projetos (PBP)}: os alunos trabalham em projetos significativos e de longo prazo que desativam pesquisa, planejamento e execução, podem abranger diversas disciplinas e promover a colaboração, a criatividade e a resolução de problemas.
    ...
    \item \textbf{Aprendizagem colaborativa}: a aprendizagem colaborativa envolve os alunos trabalhando em grupos para alcançar objetivos de aprendizagem. Eles compartilham conhecimentos, resolvem problemas juntos e aprendem uns com os outros, promovendo habilidades de trabalho em equipe e comunicação.
    \item \textbf{Gamificação}: a gamificação incorpora elementos de jogos na aprendizagem para torna-la mais envolvente e motivadora.
...
% (##)
De acordo com \citeonline{MORAN2012} (p.16) ``os métodos tradicionais, que privilegiam a transmissão de informações pelos professores, faziam sentido quando o acesso à informação era difícil''.
...
Segundo \cite{CAMARGO2018} (p.16) ``o uso de metodologias ativas de aprendizagem desenvolve competências pessoais e profissionais, além daquelas desenvolvidas na aula tradicional''. Segundo  \cite{CAMARGO2018} (p.16), ``a utilização de atividades de aprendizagem mais ativas, por meio de práticas colaborativas, melhoram o aprendizado e a capacidade de retenção do conhecimento''.
...
A Aprendizagem Baseados em Problemas (PBL) é uma técnica didática pedagógica que se enreda a partir de um problema, para promover luzes a competências e habilidades na resolução do problema, fortalecendo definições imprescindíveis para construções de saberes \cite{SILVA-LINS-LEAO2019}. A Aprendizagem Baseada em Problemas (ABP) é uma abordagem educacional que coloca o aluno no centro do processo de aprendizagem, incentivando-o a ser um aprendiz ativo e autônomo. Nesse método, os alunos aprendem através da resolução de problemas reais ou simulados, em vez de simplesmente receber informações passivamente. 

\cite{NUNES2022} (p.49) diz que ``conforme o próprio termo esclarece, na Aprendizagem Baseada em Problemas, o foco central de todo processo são os problemas''. O autor continua dizendo que ``nessa perspectiva, o problema é uma situação incerta assentada na experiência do estudante e, por esse motivo, o faz pensar verdadeiramente para resolvê-lo e tornar a situação determinada'' (p.49). A ``[...] aprendizagem por problemas é uma condição da existência humana. Nas nossas tentativas para resolver muitos problemas do cotidiano, a aprendizagem ocorre'' \cite{SOUZA2016} (p.55).

Para \cite{BACICHMORAN2018} (p.61) ``a grande vantagem (...) é criar oportunidades para o aluno aplicar o que está aprendendo e também desenvolver algumas habilidades e competências''. Os autores continuam dizendo que ``o método PBL pode ser desenvolvido individualmente ou em grupos, dentro de uma unidade curricular ou como projetos integradores (interdisciplinares)''.

``O PBL tem como premissa básica o uso de problemas da vida real ou realísticos para estimular o desenvolvimento conceitual, procedimental e atitudinal do discente'' \cite{NUNES2022} (p.38). Já \cite{JUNIOR2021} (p.15) diz que ``o PBL baseia-se exatamente nessa premissa de estimular aos alunos a discutir, formular e encontrar respostas para um problema cotidiano proposto pelo professor''.

Segundo \cite{TANGERINO2017} os objetivos da metodologia de estudos por meio de problemas:
...
Estudos de \cite{BERGMANNSANS2016} (p.29) apontam que conceitualmente a sala de aula invertida é quando ``[...] o que tradicionalmente é feito em sala de aula [...] é executado em casa, e o que tradicionalmente é feito como trabalho de casa, [...] é realizado em sala de aula''. Conforme contextualizado por \cite{VALERIO-MOREIRA2018} (p.215) a metodologia da Sala de Aula Invertida consiste em um método de estudo que permite aos alunos um contato prévio com os conteúdos ``[...] materiais produzidos e/ou disponibilizados antecipadamente pelos professores, quase sempre com mediação de tecnologias digitais''.
...
No entanto, a implementação da sala de aula invertida requer planejamento cuidadoso por parte dos professores, acesso à tecnologia e a criação de recursos de aprendizagem eficazes para os alunos estudarem em casa. Além disso, é importante garantir que os alunos tenham acesso aos recursos e ao suporte necessários para terem sucesso nesse modelo. \cite{VALENTE2018} (p.85) afirma que, com a metodologia aplicada à sala de aula invertida, ``o conteúdo e as instruções são estudados on-line antes de o aluno frequentar a sala de aula, que agora passa a ser o local para trabalhar os conteúdos já estudados''.
...
A aprendizagem entre pares oferece vários benefícios de acordo com \cite{BACICHMORAN2018}, incluindo:

\begin{itemize}
    \item Diversidade de Perspectivas: Os alunos trazem diferentes pontos de vista e experiências para o processo de aprendizagem, enriquecendo a compreensão do tópico.
    \item Aprendizado Ativo: Os alunos são mais ativos e envolvidos no processo de aprendizagem, em vez de apenas receberem informações passivamente.
    \item Desenvolvimento de Habilidades Sociais: Os alunos melhoram suas habilidades de comunicação, colaboração e trabalho em equipe.
    \item \textit{Feedback} Significativo: A avaliação entre pares pode fornecer \textit{feedback} significativo e específico, ajudando os alunos a melhorar seu trabalho.
    \item Aprendizado Autônomo: Os alunos podem se tornar mais independentes em sua aprendizagem, pois aprenderem a buscar ajuda e recursos entre os colegas.
\end{itemize}
...
\cite{CABRAL2021} (p.59) apresenta que ``o termo \textit{maker} vem do inglês `\textit{to make}' que significa fazer. O termo foi popularizado em 2005 com a primeira edição da revista `\textit{Make}', fundada por Dale Dougherty, ele utilizou a palavra \textit{makers}, produtores / fazedores / criadores''.
...
\cite{MARINI2019} diz que o pilar da Cultura Maker é a ideia de que qualquer pessoa pode construir, fabricar, reparar ou alterar os objetos com suas mãos, com a colaboração e informações entre pessoas e grupos, com a utilização de um ou de vários recursos.
...
Para \cite{CABRAL2021} a cultura maker é, uma ideia que se relaciona com a ideia de criar o ``algo'' a partir da não existente materialmente, que pulsa como a impressão de um ``nada'' que nos impulsiona à criação, uma vez que a ideia (que é o algo) pode se materializar por recursos criativo-imaginativos.
...
\subsection{Desafios da implementação das Metodologias Ativas}
...
Professores, alunos e até mesmo instituições podem resistir à mudança nas práticas de ensino tradicionais, em função da experiência do aprender, estimulando a autoaprendizagem e a co-aprendizagem, como forma de aquisição de conhecimentos, habilidades, valores e atitudes.  A transição para metodologias ativas muitas vezes exige uma mudança cultural e pode encontrar resistência inicial, como teorizado por \cite{BEHRENS2014} (p.53), quando teoriza que o ``advento da mudança de paradigma na ciência ensejou novas abordagens na educação''.
...
Como explicou \cite{VALERIO-MOREIRA2018}, sobre o método de sala de aula invertida: 
...
Utilizando a minha experiência como professora, digo que trabalhar com a metodologia da sala de aula invertida é muito desafiador, uma vez que o planejamento utiliza bastante tempo para a elaboração de conteúdos para apoio, para que alguma fora o estudante consiga encontrar a solução dos problemas que estão sendo trabalhados.
...
De acordo com \citeonline{resolucaoDeProblemas2019} (p.45), ``nesta fase, exercitam a expressão de ideias para o que necessitarão utilizar e aprimorar a linguagem, a fim de expressar-se com clareza e coerência e fazer-se entender''.
...
Depois de sanadas as dúvidas e analisadas as resoluções e soluções obtidas para o problema, ``o professor tenta chegar a um consenso sobre o resultado correto'' \cite{resolucaoDeProblemas2019} (p.46).
...
Dentre as vantagens da aplicação da Aprendizagem Baseada em Problemas, \cite{NUNES2022} (p.55) destaca que no desenvolvimento da metodologia ``estão o desenvolvimento de habilidades e atitudes, como oralidade, capacidade argumentativa, escrita e trabalho em grupo que são necessárias a todos os profissionais''. 
...
De acordo com a BNCC \cite{Educacao.2018} (p.265):
...
A BNCC \cite{Educacao.2018}, conforme mencionado, reconhece que a Matemática é uma ciência hipotético-dedutiva, fundamentada em sistemas de axiomas e postulados. No entanto, ela ressalta a importância do papel heurístico das experimentações no processo de aprendizagem matemática. Esse enfoque destaca que a exploração prática, a investigação e a experimentação têm um papel crucial não apenas na compreensão dos conceitos matemáticos, mas também no desenvolvimento do pensamento crítico e na construção de argumentações consistentes pelos estudantes.

Para \cite{FREITAS2020} (p.15) ``para haver aprendizagem precisa-se de coisas simples e interessantes, pois basta que educadores opinem práticas pedagógicas nas quais o elemento lúdico é concebido como fio condutor''. Para o autor, para promover aprendizagem, é essencial que as práticas pedagógicas sejam simples e interessantes, incorporando o elemento lúdico como um fio condutor. Isso ressalta a importância de tornar o processo educativo envolvente e significativo para os estudantes, estimulando o interesse e facilitando a assimilação do conhecimento.

De acordo com \cite{ANASTASIOU2004} (p.69) ``o professor deverá ser um verdadeiro estrategista, o que justifica a adoção do termo estratégia, no sentido de estudar, selecionar, organizar e propor as melhores ferramentas facilitadoras para que os estudantes se apropriem do conhecimento''.
...
Por envolver os estudantes, a pesquisa foi inicialmente submetida à apreciação da escola, conforme autorização no \autoref{ApendiceA}.
...
\section{Sujeitos da pesquisa}
 ...
 A pesquisa é de caráter qualitativo e a aplicação didática com coleta de dados serão desenvolvidas, no decorrer do 2º bimestre do ano de 2024, com alunos de 2º ano do Ensino Médio Integral/Formação de Professores, do Colégio Estadual Alberto Torres, Código INEP: 33013497, uma escola pública da rede estadual de ensino, localizada no município de São João da Barra, estado do Rio de Janeiro, situada na Rua João Francisco de Almeida, 439.  
...
De acordo com \cite{SEVERINO2007} (p.125) o questionário permite ``levantar
...
\begin{table}[htbp] \centering
  \caption{Distribuição da sequência de atividades}
  \label{tab:Elaboração de sequência de atividades}
...
\section{Detalhamento das atividades indicadas na sequência didática}
...
\begin{CenteredFigure}
    ...
    % \includegraphics[width=0.5\linewidth]{00-Figuras planas e espaciais}
    \legend{\autoria}
\end{CenteredFigure}

Foi apresentado aos estudantes a temática a ser desenvolvida. E, nesta primeira etapa introduziu-se a geometria espacial, mostrando a diferença entre figuras bi-dimensionais e tri-dimensionais. Para isso usou-se moldes de papel no formato de triângulo, retângulo e quadrado e os sólidos geométricos, de acrílico, existentes na escola (\autoref{fig:00-Figuras planas e espaciais}). Os alunos foram instigados a observarem, detalhadamente, os sólidos geométricos e separarem-os em dois grupos por semelhança. Inicialmente, separaram os que "rolam" (não-poliedros) daqueles que "não rolam" (poliedros). Foi solicitado, em seguida, que observassem apenas os poliedros e os separassem em dois subgrupos. Separaram os prismas (que possuem duas bases) das pirâmides (que possuem apenas uma base). Após esta familiarização iniciou-se a aplicação da sequência didática da resolução do problema a ser resolvido, conforme \autoref{ApendiceB}. A turma foi dividida em cinco grupos para que fosse trabalhado ao longo de toda a sequência didática. 
...
Problema Gerador: confecção de um Álbum de Figurinhas sobre Poliedros.

Cada aluno recebeu um pacotinho contendo 20 figuras em papel fotográfico adesivo e um álbum impresso em forma de livreto, composto por 6 páginas com 20 espaços e sua respectiva descrição ou definição, para que o aluno pudesse identificar qual a figura deverá ser colada ali (\autoref{ApendiceM}).
...
Esta atividade avaliativa foi maravilhosa! Os alunos adoraram!

E foi incrível observar que cada aluno, intuitivamente, usou um recurso diferente para facilitar a identificação correta da figura que ocuparia determinado espaço e que não mais poderia ser usada outra vez. Alguns numeraram o verso da figura, outros separaram por página, outros desenharam a figura no espaço do álbum, separar as figuras em pilhas, colocar o nome da figura. 

Foi muito gratificante perceber que alguns alunos quando foram colar a última figura perceberam que, colaram na posição errada alguma figura pois a que sobrou não possuía as caraterísticas descritas no espaço que sobrou no álbum. E aí, perguntaram se poderiam descolar. Os alunos conseguiram descolar e refazer, corretamente.
...
\subsection{TEMPORÁRIO. APAGAR DEPOIS DE DISTRIBUIR AS FOTOS}
...
% \begin{CenteredFigure}
%   \caption{Aulas 23 e 24 - Colagem correta no Álbum de Figurinhas}
%   \label{fig: 260 - Aulas 23 e 24 - Colagem correta no Álbum de Figurinhas}
%   \includegraphics[width=0.5\linewidth]{Novas imagens/260 - Aulas 23 e 24 - Colagem correta no Álbum de Figurinhas}
%   \legend{\autoria}
% \end{CenteredFigure}

% \begin{CenteredFigure}
%   \caption{Aulas 23 e 24 - Colagem correta no Álbum de Figurinhas}
%   \label{fig: 262 - Aulas 23 e 24 - Colagem correta no Album de Figurinhas}
%   \includegraphics[width=0.5\linewidth]{Novas imagens/262 - Aulas 23 e 24 - Colagem correta no Álbum de Figurinhas}
%   \legend{\autoria}
% \end{CenteredFigure}

% \begin{CenteredFigure}
%   \caption{Aulas 23 e 24 - Colagem incorreta no Álbum de Figurinhas}
%   \label{fig: 263 - Aulas 23 e 24 - Colagem incorreta no Album de Figurinhas}
%   \includegraphics[width=0.5\linewidth]{Novas imagens/263 - Aulas 23 e 24 - Colagem incorreta no Álbum de Figurinhas}
%   \legend{\autoria}
% \end{CenteredFigure}

% \begin{CenteredFigure}
%   \caption{Aulas 23 e 24 - Colagem correta no Álbum de Figurinhas}
%   \label{fig: 264 - Aulas 23 e 24 - Colagem correta no Album de Figurinhas}
%   \includegraphics[width=0.5\linewidth]{Novas imagens/264 - Aulas 23 e 24 - Colagem correta no Álbum de Figurinhas}
%   \legend{\autoria}
% \end{CenteredFigure}


% \begin{CenteredFigure}
%   \caption{Aulas 11 e 12 - grupo 21}
%   \label{fig: 269 - Aulas 11 e 12 - grupo 2}
%   \includegraphics[width=0.5\linewidth]{Novas imagens/269 - Aulas 11 e 12 - grupo 2}
%   \legend{\autoria}
% \end{CenteredFigure}

\subsection{Análise das Aulas 1 e 2}

Nesta aula introdutória foi explicado aos estudantes a importância das práticas através das atividades/questionários para seu aprendizado e como ajudará a ajustar o ensino às suas necessidades, reforçando que não é uma avaliação formal, mas uma ferramenta de diagnóstico, que será aplicado em após cada aula.
...
Todos os grupos acertaram a resolução do problema gerador que foi a questão do ENEM 2018 envolvendo o jogo Minecraft (\autoref{ApendiceB}).

\begin{table}[htbp] 
    \centering
    \caption{Acertos na atividade das aulas 1 e 2}
    \label{tab:Acertos do Encontro 1}
...
Nessa aula cada grupo ficou responsável por um dos 5 poliedros platônicos, da seguinte forma:  Tetraedro (grupo 1), Cubo (grupo 2), Octaedro (grupo 3), Dodecaedro  (grupo 4) e Icosaedro (grupo 5). Cada grupo recebeu sua atividade específica (\autoref{ApendiceC}), na qual determinava como deveria realizar suas 3 tarefas que foram:

\begin{CenteredFigure}
    \caption{Sólidos platônicos produzidos pelos alunos} \label{fig:2-solidos platonicos}
    % \includegraphics[width=0.5\linewidth]{02-Sólidos platônicos produzidos pelos alunos}
    \legend{\autoria}
\end{CenteredFigure}
...
\begin{table}[htbp] 
    \centering
    \caption{Acertos na atividade das aulas 3 e 4}
    \label{tab:Acertos do Encontro 2}
    \begin{tabular}{|c|c|c|c|c|c|c|}
        \hline
        \textbf{Grupos} & \textbf{Grupo 1} & \textbf{Grupo 2} & \textbf{Grupo 3} & \textbf{Grupo 4} & \textbf{Grupo 5} \\
        \hline
...
\subsection{Análise das Aula 5 e 6}

A aula iniciou com uma revisão da aula anterior e, em seguida, cada grupo recebeu uma folha de exercícios de fixação.
...
\end{CenteredFigure}
 ...
 Analisando o aproveitamento dos grupos encontramos o seguinte resultado \autoref{tab:Acertos do Encontro 3}.
 
\begin{table}[htbp] 
    \centering
    \caption{Acertos na atividade das aulas 5 e 6}
    \label{tab:Acertos do Encontro 3}
    \begin{tabular}{|c|c|c|c|c|c|c|}
        \hline
        \textbf{Grupos} & \textbf{Grupo 1} & \textbf{Grupo 2} & \textbf{Grupo 3} & \textbf{Grupo 4} & \textbf{Grupo 5} \\
        \hline
...
\subsection{Análise das Aula 7 e 8}

O Problema Gerador selecionado para este encontro é: cobrir, com papel colorido, todas as superfícies da embalagem em formato de poliedros – Prismas. Em seguida, calcular a quantidade de papel que o grupo gastou para cobrir a lateral e toda a superfície do poliedro.
...
Este tipo de experimento foi muito curtido por todos os alunos! 

% \begin{CenteredFigure}
%     \caption{Embalagens antes de serem forradas} \label{fig:4-embalagens antes}
%     \includegraphics[width=0.5\linewidth]{04-Aula 7 e 8 Embalagens ANTES}
%     \legend{\autoria}
% \end{CenteredFigure}

% \begin{CenteredFigure}
%     \caption{Embalagens depois de forradas} \label{fig:5-embalagens depois}
%     \includegraphics[width=0.5\linewidth]{05-Aula 7 e 8 - Embalagens DEPOIS}
%     \legend{\autoria}
% \end{CenteredFigure}

O aproveitamento dos grupos neste encontro está registrado na tabela abaixo:

\begin{table}[htbp] 
    \centering
    \caption{Acertos na atividade das aulas 7 e 8}
    \label{tab:Acertos do Encontro 4}
    \begin{tabular}{|c|c|c|c|c|c|c|}
        \hline
        \textbf{Grupos} & \textbf{Grupo 1} & \textbf{Grupo 2} & \textbf{Grupo 3} & \textbf{Grupo 4} & \textbf{Grupo 5} \\
        \hline
...
% \begin{CenteredFigure}
%   \caption{Aulas 7 e 8 - Grupo 1 acertou todos os cálculos da área lateral e total do prisma}
%   \label{fig: 266 - Aulas 7 e 8 - Grupo 1 acertou todos os calculos da area lateral e total do prisma}
%   \includegraphics[width=0.5\linewidth]{Novas imagens/266 - Aulas 7 e 8 - Grupo 1 acertou todos os cálculos da área lateral e total do prisma}
%   \legend{\autoria}
% \end{CenteredFigure}

% \begin{CenteredFigure}
%   \caption{Aulas 7 e 8 - Grupo 2 não acertou todos os cálculos da área lateral e total do prisma}
%   \label{fig: 267 - Aulas 7 e 8 - Grupo 2 nao acertou todos os calculos da area lateral e total do prisma}
...
Fizemos uma recapitulação, cada grupo de alunos recebeu uma folha de exercícios de fixação. Esses exercícios tinham como objetivo principal reforçar a habilidade dos alunos em calcular as áreas laterais e totais de qualquer prisma, contanto que tivessem as informações necessárias sobre a forma da base, suas dimensões e a altura do prisma.

\begin{CenteredFigure}
    \caption{Grupo 3 apresentando os cálculos da questão 3} \label{fig:6-grupo 3 calculos}
    \includegraphics[width=0.5\linewidth]{06-Grupo 3 - Apresentando seus cálculos}
    \legend{\autoria}
\end{CenteredFigure}
...
\begin{table}[htbp] 
    \centering
    \caption{Acertos na atividade das aulas 9 e 10}
    \label{tab:Acertos do Encontro 5}
    \begin{tabular}{|c|c|c|c|c|c|c|}
        \hline
        \textbf{Grupos} & \textbf{Grupo 1} & \textbf{Grupo 2} & \textbf{Grupo 3} & \textbf{Grupo 4} & \textbf{Grupo 5} \\
        \hline
...
\begin{CenteredFigure}
  \caption{Aulas 9 e 10 - Questão 7 - resposta correta}
  \label{fig: 251 - Aulas 9 e 10 - Questao 7 - resposta correta}
  \includegraphics[width=0.5\linewidth]{Novas imagens/251 - Aulas 9 e 10 - Questão 7 - resposta correta}
  \legend{\autoria}
\end{CenteredFigure}

\begin{CenteredFigure}
  \caption{Aulas 9 e 10 - Questão 7 - resposta incorreta}
  \label{fig: 252 - Aulas 9 e 10 - Questao 7 - resposta incorreta}
...
O objetivo deste encontro foi calcular o volume dos prismas.
...
formalizou-se, após a plenária que, para calcular a capacidade de um prisma, você precisa conhecer as dimensões do prisma e aplicar a fórmula adequada para encontrar seu volume. O volume de um prisma depende da forma de sua base e da altura do prisma.
...
\begin{table}[htbp] 
    \centering
    \caption{Acertos na atividade das aulas 11 e 12}
    \label{tab:Acertos do Encontro 6}
    \begin{tabular}{|c|c|c|c|c|c|c|}
        \hline
        \textbf{Grupos} & \textbf{Grupo 1} & \textbf{Grupo 2} & \textbf{Grupo 3} & \textbf{Grupo 4} & \textbf{Grupo 5} \\
        \hline
...
Neste encontro o objetivo foi fixar e calcular, corretamente, o volume dos prismas. Iniciou-se fazendo uma recapitulação da definição de volume e destacando que é muito importante, inicialmente, identificar a base do prisma para que se possa calcular, corretamente, a sua área. E que em seguida, para se calcular corretamente o volume do prisma basta multiplicar a área da base pela altura do prisma. Em seguida, cada grupo recebeu a sua folha de exercícios de fixação do conceito de volume de prisma (\autoref{fig:9-grupo 5 exercicios fixacao}). Cada grupo apresentou sua solução a serem analisadas e debatidas na plenária.
...
O grupo 2 apresentou certa dificuldade para entender e resolver algumas questões, como mostrada na figura 

\begin{table}[htbp] 
    \centering
    \caption{Acertos na atividade das aulas 13 e 14}
    \label{tab:Acertos do Encontro 7}
    \begin{tabular}{|c|c|c|c|c|c|c|}
        \hline
        \textbf{Grupos} & \textbf{Grupo 1} & \textbf{Grupo 2} & \textbf{Grupo 3} & \textbf{Grupo 4} & \textbf{Grupo 5} \\
        \hline
...
\begin{CenteredFigure}
  \caption{Aulas 13 e 14 - Questão 5 - resposta correta}
  \label{fig: 253 - Aulas 13 e 14 - Questao 5 - resposta correta}
  \includegraphics[width=0.5\linewidth]{Novas imagens/253 - Aulas 13 e 14 - Questão 5 - resposta correta}
  \legend{\autoria}
\end{CenteredFigure}

\begin{CenteredFigure}
  \caption{Aulas 13 e 14 - Questão 5 - resposta incorreta}
  \label{fig: 254 - Aulas 13 e 14 - Questao 5 - resposta incorreta}
...
Neste encontro o problema gerador foi: Qual a quantidade de papel colorido usado para cobrir toda a superfície da pirâmide?
...
% \begin{CenteredFigure}
%     \caption{Forrando a pirâmide quadrangular} \label{fig:11-grupo 1 forrando}
%     \includegraphics[width=0.5\linewidth]{11-Grupo 1 Pirâmide quadrangular sendo forrada}
%     \legend{\autoria}
% \end{CenteredFigure}

% \begin{CenteredFigure}
%     \caption{Pirâmides forradas pelos grupos} \label{fig:12-piramides forradas}
...
\begin{table}[htbp] 
    \centering
    \caption{Acertos na atividade das aulas 15 e 16}
    \label{tab:Acertos do Encontro 8}
...
\begin{CenteredFigure}
    \caption{Grupo 1 apresentando seus cálculos} \label{fig:13-grupo 1 calculos}
    \includegraphics[width=0.5\linewidth]{13-Grupo 1 - Apresentando seus cálculos}
    \legend{\autoria}
\end{CenteredFigure}

O grupo 1 (\autoref{fig:13-grupo 1 calculos}) apresentou certa dificuldade para entender e resolver algumas questões.

\begin{table}[htbp]
    \centering
    \caption{Acertos na atividade das aulas 17 e 18}
    \label{tab:Acertos do Encontro 9}
...
\begin{CenteredFigure}
  \caption{Aulas 17 e 18 - Questão 4 - resposta correta}
  \label{fig: 255 - Aulas 17 e 18 - Questao 4 - resposta correta}
  \includegraphics[width=0.5\linewidth]{Novas imagens/255 - Aulas 17 e 18 - Questão 4 - resposta correta}
  \legend{\autoria}
\end{CenteredFigure}

\begin{CenteredFigure}
  \caption{Aulas 17 e 18 - Questão 4 - resposta incorreta}
  \label{fig: 256 - Aulas 17 e 18 - Questao 4 - resposta incorreta}
  \includegraphics[width=0.5\linewidth]{Novas imagens/256 - Aulas 17 e 18 - Questão 4 - resposta incorreta}
  \legend{\autoria}
\end{CenteredFigure}

\subsection{Análise das Aulas 19 e 20}

Nesta aula cujo objetivo era calcular o volume da pirâmide. Não foi uma atividade de raciocínio tão imediato.
...
\begin{CenteredFigure}
    \caption{Prismas e pirâmides dos grupos} \label{fig:14-primas e piramides}
    \includegraphics[width=0.5\linewidth]{14-Prisma e Pirâmide de cada grupo}
    \legend{\autoria}
\end{CenteredFigure}

\begin{CenteredFigure}
    \caption{Medindo o volume} \label{fig:15-medindo o volume}
...
A partir deste experimento (\autoref{fig:15-medindo o volume}), os grupos apresentaram os resultados encontrados e, na plenária, concluiu-se que, todos os grupos precisaram do conteúdo de 3 pirâmides/medidor para encher, completamente, o prisma correspondente. E, assim formalizou-se que o volume da pirâmide é um terço da área da base vezes a sua altura.

Este tipo de experimento foi muito encantador para os alunos!

\begin{table}[htbp] 
    \centering
    \caption{Acertos na atividade das aulas 19 e 20}
    \label{tab:Acertos do Encontro 10}
...
Neste encontro a proposta foi a resolução dos exercícios para fixar o conceito de Volume de Pirâmides, cujo objetivo é: calcular, corretamente, o volume das pirâmides.
Para fixar esses conceitos, é essencial praticar com exercícios que envolvam diferentes formas de bases e alturas das pirâmides. Isso ajuda a consolidar a compreensão da relação entre a área da base, a altura e o volume nas diferentes figuras geométricas. Como mostra a \autoref{fig:16-grupo 5 resolucao}.
...
Percebeu-se que, o grupo 2 apresentou certa dificuldade para entender e resolver algumas questões.

\begin{table}[htbp] 
    \centering
    \caption{Acertos na atividade das aulas 21 e 22}
    \label{tab:Acertos do Encontro 11}
    \begin{tabular}{|c|c|c|c|c|c|c|}
        \hline
        \textbf{Grupos} & \textbf{Grupo 1} & \textbf{Grupo 2} & \textbf{Grupo 3} & \textbf{Grupo 4} & \textbf{Grupo 5} \\
        \hline
...
% \begin{CenteredFigure}
%   \caption{Aulas 21 e 22 - Questão 1 - resposta incorreta}
%   \label{fig: 257 - Aulas 21 e 22 - Questao 1 - resposta incorreta}
%   \includegraphics[width=0.5\linewidth]{Novas imagens/257 - Aulas 21 e 22 - Questão 1 - resposta incorreta}
%   \legend{\autoria}
% \end{CenteredFigure}

% \begin{CenteredFigure}
%   \caption{Aulas 21 e 22 - Questão 1 - resposta correta}
%   \label{fig: 258 - Aulas 21 e 22 - Questao 1 - resposta correta}
...
Nesta prática, temos uma avaliação holística dos alunos, que visa considerar o indivíduo de maneira integral. Isso significa avaliar não apenas o conhecimento teórico, mas também habilidades práticas, criativas e sociais. 
...
% \begin{CenteredFigure}
%     \caption{Estratégia de desenhar o sólido} \label{fig:17-estretegia de desenhar}
%     \includegraphics[width=0.5\linewidth]{17-Estratégia de desenhar a figurinha}
%     \legend{\autoria}
% \end{CenteredFigure}

% \begin{CenteredFigure}
%     \caption{Estratégia de numerar e reproduzir planificações} \label{fig:18-estrategia de reproduzir}
%     \includegraphics[width=0.5\linewidth]{18-Estratégia de numerar e reproduzir planificações}
%     \legend{\autoria}
% \end{CenteredFigure}

% \begin{CenteredFigure}
%     \caption{Estratégia de numerar} \label{fig:19-estrategia de numerar}
...
\begin{table}[htbp] \centering
  \caption{Tabela de Acertos no Álbum de Figurinhas}
  \label{tab:Acertos do Encontro 12}
  \begin{tabular}{|c|c|}
      \hline
...
A tabulação do percentual de acertos das atividades de todos os encontros foi feita na planilha Excel. O resultado percentual médio, por aluno, foi o seguinte, ao final deste projeto:

\begin{table}[htbp] \centering
  \caption{Média percentual de Acertos nas 12 atividades deste projeto}
  \label{tab:Resultado Final do Projeto}
  \begin{tabular}{|c|c|}
    \hline
    \textbf{Aluno} & \textbf{Percentual de acertos} \\
    \hline
...
\section{Avaliação dos alunos a sequência de atividades}
...
Trabalhar em grupo para resolver problemas pode ajudar os alunos a desenvolver habilidades de comunicação e colaboração, importantes tanto para a vida acadêmica quanto para a vida profissional. Os alunos são incentivados a pensar de forma criativa e a aplicar conhecimentos teóricos para resolver problemas práticos, o que fortalece sua capacidade de resolver problemas em contextos variados.
...
% \include{Capitulos/3.03#-apendice}

% \include{Capitulos/3.04#-anexo}
% \include{Capitulos/3.05#-indice}
