...
\begin{itemize}
    \item \textbf{2. Poliedros Convexos}
\end{itemize}
...
\begin{itemize}
    \item \textbf{3. Poliedros Platônicos}
\end{itemize}
...
\begin{itemize}
    \item \textbf{4. Prisma: definição, superfícies e volume} % superfície lateral e total do}
\end{itemize}
...
\begin{itemize}
    \item \textbf{6. Pirâmide: definição, superfícies e volume}
\end{itemize}
