...
\begin{CenteredFigure}
  \caption{Aulas 5 e 6 - Questão 9 resposta certa e errada}
  \label{fig: 250 - Aulas 5 e 6 - Questao 9 resposta certa e errada}
  \includegraphics[width=0.5\linewidth]{Novas imagens/250 - Aulas 5 e 6 - Questão 9 resposta certa e errada}
  \legend{\autoria}
\end{CenteredFigure}
...
A partir deste experimento (\autoref{fig:15-Aulas 19 e 20 - Medindo o volume}), os grupos apresentaram os resultados encontrados e, na plenária, concluiu-se que, todos os grupos precisaram do conteúdo de 3 pirâmides/medidor para encher, completamente, o prisma correspondente. E, assim formalizou-se que o volume da pirâmide é um terço da área da base vezes a sua altura.
...
% \include{Capitulos/3.04#-anexo} % Não usado
