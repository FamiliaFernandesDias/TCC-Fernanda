...
Todos os grupos acertaram a resolução do problema gerador que foi a questão do ENEM 2018 envolvendo o jogo Minecraft (\autoref{ApendiceB}). Mas, na hora de responder o questionamento alguns grupos erraram, como observa-se na \autoref{tab:Acertos do Encontro 2}.
...
\begin{CenteredFigure}
    ...
    \includegraphics[width=\linewidth]{Novas imagens/250 - Aulas 5 e 6 - Questão 9 resposta certa e errada}
    \legend{\autoria}
\end{CenteredFigure}
