...
Analisando o aproveitamento dos grupos encontramos o seguinte resultado \autoref{tab:Acertos do Encontro 3}. E, na \autoref{fig: 250 - Aulas 5 e 6 - Questao 9 resposta certa e errada} encontra-se a resolução correta (baixo) e a incorreta (cima) da questão 9 do Exercício de Fixação das Aulas 5 e 6 (\autoref{ApendiceD}).
