...
Para melhor entender os sólidos geométricos, é importante revisar algumas definições matemáticas básicas. Ressalta-se que toda essa subseção se apresenta fortemente baseada nos conceitos matemáticos apresentados por \citeonline{Fundamentos10_2022}, \citeonline{Fundamentos9_2022} e \citeonline{Elon_2022}.

\begin{itemize}
    \item \textbf{1. Sólidos Geométricos} \label{sec:2.5_Solidos Geometricos}
\end{itemize}
...
\begin{CenteredFigure}
    \caption{Poliedros Convexo e Côncavo} \label{fig:poliedro}
