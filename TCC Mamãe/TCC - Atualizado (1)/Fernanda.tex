...
Uma das formulações mais conhecidas do Teorema de Euler é relacionada à teoria dos grafos e é conhecida como ``Fórmula de Euler para Grafos Planos''. Essa fórmula estabelece uma relação entre o número de vértices (V), o número de arestas (A) e o número de faces (E) em um grafo plano conexo, ou seja, um grafo que pode ser desenhado em um plano sem que suas arestas se cruzem. A fórmula é dada por: \textcolor[HTML]{0000FF}{$V - E + F = 2$} \cite{Siqueira2009}.
