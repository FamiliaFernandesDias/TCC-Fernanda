...
\begin{citacao}
    ...
    $$B \subset A \Rightarrow \text{Área de B} \leqslant \text{Área de A}$$\cite[Alterado pela autora]{Fundamentos9_2022}
\end{citacao}
...
Chama-se apótema de uma pirâmide regular à altura (relativa ao lado da base) de uma face lateral (\autoref{fig:apótema}).

\begin{CenteredFigure}
    \caption{Apótema de uma pirâmide} \label{fig:apótema}
    \includegraphics[width=0.5\textwidth]{Imagens/Novas imagens/Apótema}
    \legend{Fonte: \citeonline{Fundamentos10_2022}}
\end{CenteredFigure}

A \autoref{fig:piramide} ilustra o cálculo de volume.
